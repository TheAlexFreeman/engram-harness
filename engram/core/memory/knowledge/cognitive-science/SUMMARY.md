...
## Consciousness and the User Illusion *(new 2026-04-26)*

Root-level file:
- `user-illusion-consciousness.md` — Nørretranders's bandwidth argument (11M vs. 40 bits/s); exformation; Libet experiments; Dennett's Multiple Drafts Model and heterophenomenology; Frankish's illusionism; Humphrey's evolutionary sentience theory and ipsundrum; critiques (Chalmers's hard problem); connections to predictive processing and GWT

See also: `philosophy/sellars-manifest-scientific-image.md` (the manifest/scientific image problem this theory addresses), `philosophy/hoffman-interface-theory-conscious-agents.md` (radical inversion: physics as interface generated by consciousness), `cognitive-science/species-specific-reality-consciousness.md` (Nagel's phenomenal datum).
