---
created: '2026-04-26'
origin_workspace: workspace/projects/llm-cognitive-frames/notes/narrative-semiotic-frames-llms.md
session_id: act-005
...
source: agent-generated
trust: medium
related: philosophy/narrative-cognition.md, cognitive-science/affordance-umwelt-enaction-synthesis.md, cognitive-science/umwelt-uexkull-biosemiotics.md
created: 2026-04-26
---
...
Drawing on the foundations in `narrative-cognition.md`, `cognitive-linguistics-metaphor-blending.md`, and the umwelt files:
...
## Cross-References
- `philosophy/narrative-cognition.md` (Bruner, Ricoeur, Lakoff, DMN, force dynamics — the foundational theory)
- `cognitive-science/affordance-umwelt-enaction-synthesis.md` (narrative as participatory knowing and relevance realization in LLM context)
- `cognitive-science/umwelt-uexkull-biosemiotics.md` (narrative as technology for constituting stable meaning-carriers and functional circles)
- `philosophy/cognitive-linguistics-metaphor-blending.md` (blending and image schemas as narrative primitives)
- New companion file `cognitive-science/llm-umwelten-affordances-interfaces.md`

This file is ready for promotion to `memory/knowledge/philosophy/narrative-semiotic-frames-llms.md` or `cognitive-science/`. Together with the umwelt/affordance file, they fulfill the project goal. Update relevant SUMMARY.md files after promotion.