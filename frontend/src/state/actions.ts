export type SessionAction =
  ...
  // Trace events
  | { type: "TOOL_CALL"; name: string; args: Record<string, unknown>; turn: number; seq?: number }
  | { type: "TOOL_RESULT"; name: string; isError: boolean; turn: number; result?: string; seq?: number }
